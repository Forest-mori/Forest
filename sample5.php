...
<body>
  <!--右から流れるアニメーション文字-->
  <Marquee bgcolor ="blue">プリッター(かり)[2014/07/04]</Marquee>
    <!--右から流れるアニメーション文字-->
  ...
  <input type="text" x-webkit-speech>
    ...
    <div style="margin:0;padding:0;font-size:14pt;border:none;background-color:#FFF;">
	  ...
	  <img src="http://i.yimg.jp/images/search/guide/searchbox/yjapan_logo_110_29.gif" alt="Yahoo! JAPAN" border="0" width="110" height="29"></a></p>
	<form method="get" action="http://search.yahoo.co.jp/search" target="_blank" style="margin:0;padding:0;">
	  <p style="margin:0;padding:0;">
	    <input size="35" name="p" style="vertical-align:top;margin:0;width:45%;">
	      <input type="image" height="21" alt="画像検索" width="47" src="http://i.yimg.jp/images/top/searchbox/s_i.gif" border="0" name="isearch" style="margin:0 0 0 2px;">
	      </p>
	      <input type="hidden" name="fr" value="ysvw">
		<input type="hidden" name="ei" value="▲▲▲"></form>
		...
		<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
		  <input type=button value="トップページ" onclick="window.location.href= 'sample5.php'">
		    <p>    
  ...
  if(array_key_exists($_POST["keyword"], $tf_data) && $_POST["keyword"] <>null ){
    ...
    foreach($tf_data[@$_POST["keyword"]] as $key => $val ) {
      if (@$_POST["number"] == @$fc_data[$key] && @$_POST["number"]<>null){
		echo "<a href = '$str1'><img src='$key'></a><br>\n";
          //隅田変更aaaa
